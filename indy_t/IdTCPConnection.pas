...
begin
 // WriteLn('1 SetIOHandler');
  ...
  //   WriteLn(' SetIOHandler 2');
    if ManagedIOHandler and Assigned(FIOHandler) then
    begin
    //  WriteLn('start IOHandler FreeAndNil');
      try
      FreeAndNil(FIOHandler);

      except
        //WriteLn('except IOHandler FreeAndNil');
      end;
   //   WriteLn('end IOHandler FreeAndNil');
    end;
   //   WriteLn(' SetIOHandler 3');
